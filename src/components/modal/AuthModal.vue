    ...
    <template #default>
      <div style="width: 250px; height: 200px" class="mx-auto">
        <vue-lottie-player
          ...
          height="200px"
          loop
          path="https://assets5.lottiefiles.com/packages/lf20_bcjfw1k6.json"
        />
      </div>
      ...
      <form id="authForm" class="max-w-xs mx-auto mt-4">
        ...
        <div>
          <div class="flex items-center mt-5">
            ...
            <span class="flex-shrink-0 text-xs font-medium text-gray-400 mx-3"
...
const login = async () => {
  try {
    const { data } = await $axios.post('/smileeye/ppe-core/auth/login', {
      email: email.value,
